          ...
          <Grid item container xs={12}>
            ...
            <Grid item container xs={8} sm={6} md={6} lg={6} >
              ...
              <Typography variant="h6" color="secondary" style={{marginTop: "20px", fontSize: '18px', fontFamily: 'Space Mono'}}>
                Hey there! My name is Evan Brooks, and I'm a junior pursuing a bachelor's degree in computer science at the University of Florida. My interests lie in software development, crypto, and exercising. I love to create web apps with React. My most recent project is called <Link underline="always" color="secondary" href="https://evanbrooks0629.github.io/TimeBlock/" target="_blank" style={{cursor: 'pointer'}}>TimeBlock</Link>, which is a PWA that lets you visually plan out your day. I am also a campus ambassador for <Link underline="always" color="secondary" href="https://xrpl.org/index.html" target="_blank" style={{cursor: 'pointer'}}>XRPL</Link>.
              </Typography>
              <Typography variant="h6" color="secondary" style={{marginTop: "20px", fontSize: '18px', fontFamily: 'Space Mono'}}>
